...
const SpecialistComponent: React.FC<SpecialistComponentProps> = ({doctor}: SpecialistComponentProps) => {
  return (
    <div className="mb-6 mt-[90px] pt-10 pr-20 pb-5 pl-10 bg-gray-50 items-start w-[500px]">
      <img src={doctor === "doctor1" ? doctor1 : doctor2} alt="" className="mb-6 -mt-[90px]"/>
      ...
      Elementum libero hac leo integer. Risus hac road<br />
      parturient feugiat. Litora cursus hendrerit bib elit<br />
